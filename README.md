...
Then, for mongoid:
    ...
    rails new my_app -T -O -m https://raw.github.com/ack34/rocket_cms/master/template.rb

for ActiveRecord:

    rails new my_app -T --database=postgresql -m https://raw.github.com/ack34/rocket_cms/master/template.rb
